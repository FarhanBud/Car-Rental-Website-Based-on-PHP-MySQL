...
if($lastInsertId)
{
echo "<script>alert('Booking successfull, Check your MyBooking Page and Wait for the Admin response. Thank You !');</script>";
...
<title>MYCar Rental Portal | Vehicle Details</title>
<!--Bootstrap -->
