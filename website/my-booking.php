...
<title>MYCar Rental Portal - My Booking</title>
<!--Bootstrap -->
...
<tr>
  <td colspan="5" style="text-align:center;">
    <a href="payment.php?booking_id=<?php echo htmlentities($result->BookingNumber); ?>" class="btn btn-primary">Pay Now</a>
  </td>
</tr>
...
if (isset($_POST['confirmed']) && $_POST['confirmed'] == 1) {
    echo "<div class='alert alert-success text-center'>Payment has been confirmed successfully!</div>";
}
?>
